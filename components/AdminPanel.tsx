        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
           <div className="bg-white p-6 rounded-2xl border shadow-sm">
            ...
            <div className="space-y-4">
              <div className="aspect-square bg-slate-100 rounded-2xl flex items-center justify-center border-2 border-dashed border-slate-300 relative overflow-hidden">
                {config.qrCode ? <img src={config.qrCode} alt="Admin QR" className="w-full h-full object-contain" /> : <span className="text-slate-400 text-xs font-bold">No QR Uploaded</span>}
              </div>
              <input type="file" accept="image/*" onChange={handleQRUpload} className="hidden" id="qr-input" />
              <label htmlFor="qr-input" className="block text-center w-full py-3 bg-blue-600 text-white font-bold rounded-xl cursor-pointer hover:bg-blue-700 transition-colors">
